...
import { createCategoriasProducto, getCategorias } from '@/Connections/productos'
...
function Toggle({ value, onChange }) {
    return (
        <div className="flex items-center gap-3">
            ...
            <span className="text-sm" style={{ color: value ? '#3960A9' : 'rgba(31,47,87,0.5)' }}>
                ...
                >
                    ...
                    <div className="px-8 py-7 flex flex-col gap-7">
                        ...
                        <div className="flex flex-col gap-6">
                            <Field label="Código" required hint="Identificador único de la categoría">
                                <input
                                    value={form.codigo}
                          ...
                          <SwitcherLoader>
                            <Field label="Categoría padre" hint="Organiza en jerarquías jerárquicas">
                            ...
                            <Field label="Descripción">
                                <div>
                                    <textarea
                                        ...
                                        onBlur={e  => { e.target.style.borderColor = 'rgba(31,47,87,0.18)'; e.target.style.boxShadow = 'none' }}
                                    />
                                    <div className="text-right text-[11px] mt-1" style={{ color: 'rgba(31,47,87,0.35)' }}>
