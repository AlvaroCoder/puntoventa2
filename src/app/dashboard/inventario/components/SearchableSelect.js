...
return (
        <div ref={wrapRef} className="relative">
            ...
            <button
                type="button"
                onClick={handleOpen}
                className="flex items-center justify-between gap-2 h-10 px-3.5 rounded-xl w-full text-left text-sm transition-all"
                style={{
            ...
            {open && (
                <div
                    ...
                    style={{ border: '0.5px solid rgba(31,47,87,0.14)', boxShadow: '0 12px 40px rgba(31,47,87,0.14)' }}
                >
                    <div
                    ...
                    <div className="max-h-56 overflow-y-auto py-1">
                        {filtered.length === 0 ? (
                            <p className="px-4 py-5 text-xs text-center" style={{ color: 'rgba(31,47,87,0.4)' }}>
                            ...
                            filtered.map(opt => {
                                ...
                                return (
                                    <button
                                        ...
                                        style={{ background: isActive ? 'rgba(57,96,169,0.06)' : 'transparent' }}
                                    >
                                        <div
                                        ...
                                        <span className="text-sm truncate" style={{ color: '#1F2F57' }}>
                                            {opt.nombre}
                                        </span>
                                    </button>
                                )
