    ...
    return (
        <div className="w-full p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
                <div>
                    <h1 className="font-bold text-[#1F4363] text-2xl">Productos</h1>
                                                    ...
                                                    <tr key={producto.id} className="hover:bg-gray-50/60 transition-colors group">
                                                        <td className="px-4 py-3">
                                                            {producto.imagenUrl ? (
                                                                ...
                                                                <div className="w-10 h-10 rounded-xl bg-[#1F4363]/10 flex items-center justify-center text-[#1F4363] font-bold text-sm">
