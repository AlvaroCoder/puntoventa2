...
export default function Button({ children, variant = "primary", className = "", icon: Icon, onClick=()=>{} }) {
  ...
  const variants = {
    primary: "bg-azulMarino text-white hover:bg-azulMarino/80 shadow-azulMarino/20",
